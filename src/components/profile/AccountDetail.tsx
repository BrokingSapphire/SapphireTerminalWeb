...
const BankAccountInterface = () => {
  return (
    <div className="w-full bg-[#F8F8FB] dark:bg-[#121212]">
      <div 
        className="rounded-lg w-full bg-white dark:bg-[#121212] border border-gray-200 dark:border-[#2F2F2F]"
        style={{
          // background: '#F8F8FB',
      ...
      >
        ...
        >
          {/* Bank of Baroda */}
          <div 
            className="bg-white dark:bg-[#121212] rounded-lg border border-gray-200 dark:border-[#2F2F2F] relative w-full"
            style={{
              borderRadius: '8px',
              borderWidth: '1px',
              padding: '16px',
          ...
          >
            ...
            <div className="space-y-2 ml-12">
              <div className="flex justify-between">
                <span 
                  className="text-gray-600 dark:text-[#A0AEC0]"
                  style={{
                    width: '75px',
                    height: '15px',
                    fontFamily: 'Inter',
          ...
          >
            ...
            <div className="space-y-2 ml-12">
              <div className="flex">
                ...
                <span 
                  className="text-gray-900 dark:text-[#EBEEF5] ml-auto"
                  style={{
                    width: '105px',
                    height: '15px',
                    fontFamily: 'Inter',
