...
const GiftStocksPage: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#121212] w-full flex items-center justify-center p-2 sm:p-4">
      {/* Main Container - Shifted Left */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center bg-[#F8F8FB] dark:bg-[#121413] dark:border dark:border-[#2F2F2F] rounded-lg p-4 sm:p-5 lg:p-6 w-full lg:h-[269px] gap-6 lg:gap-0">
